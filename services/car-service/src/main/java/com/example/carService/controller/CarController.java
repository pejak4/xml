...
public class CarController {
    ...
    @CrossOrigin(origins = "https://localhost:3000")//Kada se plati, taj placeni oglas prelazi u stanje PAID
    ...
    @CrossOrigin(origins = "https://localhost:3000")//Kada se plati, svi zahtevi za isti auto u isto vreme ce biti odbijeni
...
//    }
    ...
    @CrossOrigin(origins = "https://localhost:3000")//ako je taj auto vec rezervisan u tom periodu
